...
echo "<header>
    <h1>HR Department Search Results for <i>$dept</i></h1>
    </header>
    <main>";
...
if (mysqli_num_rows($result) == 0) {
    ...
    if (mysqli_num_rows($result) == 0) {
        ...
        echo "<tr><th colspan=2>Name</th><th>Email</th><th>Phone</th><th>Job</th></tr>";
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            $job = $row['job_title'];
            echo "<tr><td>$first_name</td><td>$last_name</td><td>$email</td><td>$phone</td><td>$job</td></tr>";
        }
        echo "</table>";
    }
}
